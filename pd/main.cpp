/*---------------- File: main.cpp  ---------------------+
|Modelo PLI - Problema da Designação (PD)               |
|					      		                        |
|					      		                        |
...
struct aresta {
	int w;	//custo da tarefa / pessoa
};

//Conjuntos do Problema
int O; //Quantidade de pessoas
vector<vector<aresta>> arestas; //Conjunto dos custos
int D; //Quantidade de tarefas 
